            ...
            <div className="flex flex-col gap-3 mb-5">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={handleAdd}
                        disabled={loading}
                        className="px-4 py-2 cursor-pointer bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-lg shadow-sm shadow-blue-600/20 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                    ...
                    <div key={task.id} className="group p-3 rounded-lg bg-white border border-gray-200 hover:border-blue-300 transition-all flex items-start gap-3 shadow-sm hover:shadow-md">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-start">
                                ...
                                <button onClick={() => handleDelete(task.id)} className="text-gray-400 cursor-pointer hover:text-red-600 transition-colors opacity-0 group-hover:opacity-100 bg-gray-50 hover:bg-red-50 p-1 rounded">
                                    <Trash2 size={12} />
                                </button>
                            </div>
